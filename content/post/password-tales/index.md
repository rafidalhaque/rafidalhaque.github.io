...
১) পাসওয়ার্ড হওয়া উচিত যতটা সম্ভব দীর্ঘ ও জটিল এবং সর্বনিম্ন ৬-৮ অক্ষর বিশিষ্ট।
২) সাইবার নিরাপত্তা বিশেষজ্ঞরা ৮ - ৩২ অক্ষরের পাসওয়ার্ডকে আদর্শ পাসওয়ার্ড বলেন।
৩) পাসওয়ার্ড হতে হবে ইংরেজি বড় ও ছোট হাতের অক্ষর (A,B,C….Z, a,b,c…z), সংখ্যা (1-9), বিভিন্ন চিহ্নের (#@$&%+=:~)মিশেল।
৪) একই পাসওয়ার্ড একাধিক অ্যাকাউন্টে ব্যবহার করা যাবে না।
৫) কোনো অবস্থাতেই পাসওয়ার্ড অন্য কারো সাথে শেয়ার করা যাবে না। হোক সে আপন কেউ!
৬) যেসব অ্যাকাউন্টে সম্ভব সেসব অ্যাকাউন্টে টু-ফ্যাক্টর অথেনটিকেশন (2FA)ব্যবহার করতে হবে।
...
NationalToday.com,	World Password Day.
...
6. Toolbox blog,	World Password Day 2022: It's Time the World Switches to Passwordless.	
https://www.toolbox.com/it-security/identity-access-management/news/world-password-day-2022/
...
9. Toolbox blog,	Locked Away: How Far Are We From a Passwordless Future? 
https://www.toolbox.com/it-security/identity-access-management/guest-article/how-far-are-we-from-a-passwordless-future/
...
পারফেক্ট পাসওয়ার্ডস বইয়ের পিডিএফঃ 
